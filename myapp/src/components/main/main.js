  ...
  render() {
    return (
      <React.Fragment>
        ...
        <div className="myContainer main__body">
          <div className="row carouselImg__outer" id="poster">
            <div className="col-lg-12 col-md-12 col-xs-12 col-sm-12" id="win">
              ...
              >
                ...
                <a
                  className="left carousel-control carouselImg__outer"
                  href="#myCarousel"
                  data-slide="prev"
                >
                ...
                <a
                  className="right carousel-control carouselImg__outer"
                  href="#myCarousel"
                  data-slide="next"
                >
              ...
              <div className="row row-30">
                ...
                <div className="col-lg-6 col-12">
                  <div className="block-sm offset-top-45">
                    <div
                      className="section-name wow fadeInRight about__heading"
                      data-wow-delay=".2s"
                    >
                      About us
                    </div>
                    ...
                    >
                      ...
                      Department of NIT Durgapur.It is solely dedicated to form
                      a network among all the students,faculty members and
                      alumni of the department. It promotes interaction within
                      the department and implements academic , social and other
                      programs of interest to its members.
                    </p>
                    <p
                      className="default-letter-spacing font-weight-bold text-gray-dark wow fadeInUp"
                      data-wow-delay=".4s"
                    >
                      We are conducting several events every year for the
                      betterment of students.
                    </p>
                    <Link
                      className="button-width-150 button-primary button-circle button-lg button offset-top-20 main__teamButton"
                      to="./member"
                    >
                      VIEW OUR TEAM{" "}
            ...
            <div className="container">
              <div className="row">
                <div className="col-xl-7 col-lg-7 col-12">
                  <div className="section-name wow fadeInRight about__heading">
                    Our Events
                  </div>
                  <h3
                    className="text-capitalize wow fadeInLeft"
                    data-wow-delay=".2s"
                  >
                    Why ChESS<span className="text-primary"> Join us</span>
                  </h3>
                  <hr />
                  ...
                  <div className="row row-15">
                    ...
                    <div className="col-xl-6 wow fadeInUp" data-wow-delay=".3s">
                      <div className="box-default">
                        ...
                        <p className="box-default-description">
                          We conduct hackathons so students can work upon
                          practical problems.
                        </p>
                    ...
                    <div className="col-xl-6 wow fadeInUp" data-wow-delay=".4s">
                      <div className="box-default">
                        ...
                        <p className="box-default-description">
                          We have a talented group of members who work to make
                          CHESS better everyday.
                        </p>
              ...
              <div className="row row-30 text-center">
                <div className="col-xl-3 col-sm-6 col-12">
                  <div className="counter-classic">
                    ...
                    <div
                      className="counter-classic-title"
          ...
          <section className="section section-md bg-lighten hod__opinion container">
            <div className="row justify-content-center">
              <div className="col-xl-10">
                <h3
                  className="wow fadeInLeft text-capitalize text-center text-dark"
                  data-wow-delay=".3s"
                >
                  Our HOD's Opinions
                  <TypeAnimation
                    cursor={false}
                    sequence={[` About CHESS`, 2050, ` About CHESS`]}
                    wrapper="span"
                    repeat={2}
                ...
                <p
                  ...
                  data-wow-delay=".4s"
                >
                  Chemical Engineering Students' society is working with a
                  motivation of developing professional and personal skills of
                  students, which facilitate them to perform magnificently as an
                  eminent engineer in the society. This society is aimed to
                  provide a platform to showcase and sharpen student's talents
                  through a variety of events and activities planned throughout
                  four years, for overall development of students personalities.
                  We continue our effort to prepare and guide the students for
                  the various competitive exams and interviews so that they
                  perform better and make their carrier in the selected
                  fields.Real world problems will be blended in the curriculum
                  and these are to be taught by experts from industry, in
                  addition through guest lectures. Our focus is to effectively
                  train our students as chemical engineers who can serve the
                  society competently, collaboratively and ethically as
                  planners, designers and operators of the environment.
                </p>
              </div>
            </div>
          </section>
