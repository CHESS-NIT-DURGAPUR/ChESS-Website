                                    ...
                                    <div className="card-body">
                                        ...
                                        <p className="card-text">
                                            <ReadMore>
                                                ...
                                                restricting ChESS from organizing events like ASPIRE in Offline mode.
                                            </ReadMore>
                                        </p>
                                    </div>
                                </div>
                                    ...
                                    <div className="card-body">
                                        ...
                                        <p className="card-text">
                                            <ReadMore>
                                                ...
                                                The program included inspiring speeches by the respected professors of the department,
                                                followed by moments of fun and frolic. Arrangements for food and soft drinks were made for all attendees and guests.
